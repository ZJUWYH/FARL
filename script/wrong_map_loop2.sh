...
# bash /data/yuhui/8/memory-perturb/script/wrong_map_loop2.sh > "$LOGFILE" 2>&1
# ts=$(date '+%Y%m%d_%H%M%S')
# screen -dmS mt bash -c "bash /data/yuhui/8/memory-perturb/script/wrong_map_loop2.sh > ./log/log_$ts.log 2>&1"

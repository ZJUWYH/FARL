...
###
            ...
            python reason_perturb.py --dataset_name "$DATASET_NAME" --group_name "$GROUP" --model_name "$PERTURB_MODEL_PATH" --short_model_name "$CURRENT_SHORT_MODEL_NAME" --cot_memory_perturb_same True
            CLIENT_EXIT_CODE=$?
            echo "Client script finished with exit code $CLIENT_EXIT_CODE."

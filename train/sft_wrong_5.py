...
def load_mmlu_subset(data_path, size: int = DATASET_SIZE) -> List[Dict]:
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The specific field/subset of the MMLU dataset to process (e.g., 'high_school_world_history')."
    )
    parser.add_argument(
        "--model_name",
        type=str,
    ...
    wandb.init(project="MemoryPerturb", name=f"{DATASET_NAME}_{DATASET_FIELD}_{DATASET_SPLIT}_{SHORT_MODEL_NAME}", group="sft_wrong")
    ...
    ds = load_mmlu_subset(WRONG_ANSWER_FILE,DATASET_SIZE)
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=12,                    # Fewer epochs for larger dataset

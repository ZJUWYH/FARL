...
if __name__ == "__main__":
    ...
    SAVE_PATH = f"./res2/{DATASET_NAME}_{GROUP_NAME}_{DATASET_SPLIT}_perturb_{SHORT_MODEL_NAME}_perturbed_answers.json"
    # REPEAT = args.repeat
    print(f"Loading dataset {DATASET_NAME}/{GROUP_NAME}...")
    wandb.init(project="MemoryPerturbGroup", name=f"{DATASET_NAME}_{GROUP_NAME}_{DATASET_SPLIT}_{SHORT_MODEL_NAME}", group="perturb_infer")
...
################---------------------------inference--------------------------------------###############
    ...
    def extract_and_compare(example):
        ...
        extracted = llm_extract_answer_v2(answer, client2)
    ...
    for item in tqdm(data):
        ...
        think_draft_answer = llm_extract_answer_v2(think_draft, client2)
